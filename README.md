当前稳定版本：1.4
**由于ESP8266性能有限，无法带动物联网功能，后续逐步转至ESP32，计划逐步停止对ESP8266的支持。**
SmartUPS:充电宝当成防断电保护电源(**项目QQ群1071373946**)如果需要对应版本，移至分支下，自行烧录至硬件。
...
4. 连接成功后热点自动关闭，可通过路由器管理后台查找ESP开头设备的IP，访问新管理地址（ESP32可以直接刷新查看ip）
